...
public final class ActivityBigscreenBinding implements ViewBinding {
  ...
  private ActivityBigscreenBinding(@NonNull CoordinatorLayout rootView,
      @NonNull MaterialButton downButton, @NonNull MaterialButton homeButton,
      @NonNull MaterialButton leftButton, @NonNull MaterialButton micButton,
      @NonNull MaterialButton rightButton, @NonNull MaterialButton selectButton,
      @NonNull ToolbarBinding toolbarLayout, @NonNull MaterialButton upButton) {
